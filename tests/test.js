...
qunit.test('Popup website', function (assert) {
    ...
    assert.equal('<ons-list-item modifier="nodivider"><div class="left list-item__title">Vegan</div> <div class="right list-item__subtitle">foo</div></ons-list-item><ons-list-item modifier="nodivider" class="list-item list-item--nodivider"><div class="center list-item__center list-item--nodivider__center"> </div><div class="left list-item__title list-item__left list-item--nodivider__left list-item--nodivider__title">Website</div><div class="right list-item__subtitle list-item__right list-item--nodivider__right list-item--nodivider__subtitle"><a target=" blank" rel="noopener" href="https://www.example.com/bar">example.com</a></div></ons-list-item>', popup.getPopupRows(), 'getPopupRows');
});
